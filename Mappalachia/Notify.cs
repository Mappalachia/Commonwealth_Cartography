...
namespace Mappalachia
{
	public static class Notify
	{
		...
		public static void GenericError(string summary, string body, Exception? exception = null, string title = "Commonwealth Cartography: Error")
		{
		...
		{
			if (SpotlightInstallationPromptShown)
			{
				return;
			}
			...
			SpotlightInstallationPromptShown = true;
		}
		...
		public static void FatalException(Exception exception)
		{
			...
			TaskDialogPage page = new TaskDialogPage
			{
				Caption = "Commonwealth Cartography",
				Heading = "Unexpected error",
				Text = $"An unexpected error has occurred and Commonwealth Cartography must close.\n" +
