...
namespace Mappalachia
{
	public class Recipe(Space space, MapSettings mapSettings, PlotSettings plotSettings, SortableBindingList<GroupedSearchResult> itemsToPlot)
	{
		...
		public static Recipe? LoadFromFile(string filePath)
		{
			...
			{
				Notify.GenericError("Recipe load failed", "Commonwealth Cartography was unable to load the provided recipe file.\nError details below.", e);
				return null;
			}
		}
		...
		public void SaveToFile(string filePath)
		{
			...
			{
				Notify.GenericError("Recipe save failed", "Commonwealth Cartography was unable to save the recipe file.\nError details below.", e);
			}
		}
	}
}
